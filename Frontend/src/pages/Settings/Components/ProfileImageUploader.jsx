...
export default function ProfileImageUploader() {
  ...
  return (
    <div className="profile-avatar" onChange={uploadImage}>
      {profile?.profile_image ? (
        <img className="avatar-circle" src={`http://127.0.0.1:8000/${profile.profile_image}`} alt="Profile" />
      ) : (
      ...
      <button className="camera-btn" onClick={() => inputRef.current.click()} disabled={uploading} style={{background:"white"}} > 📷 </button>
